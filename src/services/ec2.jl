...
accept_transit_gateway_multicast_domain_associations(args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = ec2("AcceptTransitGatewayMulticastDomainAssociations", args; aws_config=aws_config)
...
associate_enclave_certificate_iam_role(args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = ec2("AssociateEnclaveCertificateIamRole", args; aws_config=aws_config)
...
- `TargetVpcSubnetId`: The ID of the subnet through which you want to route traffic. The specified subnet must be an existing target network of the Client VPN endpoint. Alternatively, if you're adding a route for the local network, specify local.
...
- `Type`: The type of request. The default value is maintain.    maintain - The EC2 Fleet places an asynchronous request for your desired capacity, and continues to maintain your desired Spot capacity by replenishing interrupted Spot Instances.    request - The EC2 Fleet places an asynchronous one-time request for your desired capacity, but does submit Spot requests in alternative capacity pools if Spot capacity is unavailable, and does not maintain Spot capacity if Spot Instances are interrupted.    instant - The EC2 Fleet places a synchronous one-time request for your desired capacity, and returns errors for any instances that could not be launched.   For more information, see EC2 Fleet request types in the Amazon EC2 User Guide.
...
# Required Parameters
- `exportToS3`: The format and location for an export instance task.
- `instanceId`: The ID of the instance.
...
create_vpc_endpoint_service_configuration(args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = ec2("CreateVpcEndpointServiceConfiguration", args; aws_config=aws_config)
...
delete_network_insights_analysis(NetworkInsightsAnalysisId, args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = ec2("DeleteNetworkInsightsAnalysis", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("NetworkInsightsAnalysisId"=>NetworkInsightsAnalysisId), args)); aws_config=aws_config)
...
delete_network_insights_path(NetworkInsightsPathId, args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = ec2("DeleteNetworkInsightsPath", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("NetworkInsightsPathId"=>NetworkInsightsPathId), args)); aws_config=aws_config)
...
delete_transit_gateway_connect(TransitGatewayAttachmentId, args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = ec2("DeleteTransitGatewayConnect", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("TransitGatewayAttachmentId"=>TransitGatewayAttachmentId), args)); aws_config=aws_config)
...
describe_addresses_attribute(args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = ec2("DescribeAddressesAttribute", args; aws_config=aws_config)
...
# Optional Parameters
- `DryRun`: Checks whether you have the required permissions for the action, without actually making the request, and provides an error response. If you have the required permissions, the error response is DryRunOperation. Otherwise, it is UnauthorizedOperation.
- `Filter`: One or more filters. Filter names and values are case-sensitive.    location - This depends on the location type. For example, if the location type is region (default), the location is the Region code (for example, us-east-2.)    instance-type - The instance type. For example, c5.2xlarge.  
...
describe_network_insights_analyses(args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = ec2("DescribeNetworkInsightsAnalyses", args; aws_config=aws_config)
...
describe_network_insights_paths(args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = ec2("DescribeNetworkInsightsPaths", args; aws_config=aws_config)
...
describe_transit_gateway_connect_peers(args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = ec2("DescribeTransitGatewayConnectPeers", args; aws_config=aws_config)
...
describe_transit_gateway_connects(args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = ec2("DescribeTransitGatewayConnects", args; aws_config=aws_config)
...
# Optional Parameters
- `DryRun`: Checks whether you have the required permissions for the action, without actually making the request, and provides an error response. If you have the required permissions, the error response is DryRunOperation. Otherwise, it is UnauthorizedOperation.
- `Filter`: One or more filters.    service-name - The name of the service.    service-type - The type of service (Interface | Gateway).    tag:&lt;key&gt; - The key/value combination of a tag assigned to the resource. Use the tag key in the filter name and the tag value as the filter value. For example, to find all resources that have a tag with the key Owner and the value TeamA, specify tag:Owner for the filter name and TeamA for the filter value.    tag-key - The key of a tag assigned to the resource. Use this filter to find all resources assigned a tag with a specific key, regardless of the tag value.  
...
disassociate_enclave_certificate_iam_role(args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = ec2("DisassociateEnclaveCertificateIamRole", args; aws_config=aws_config)
...
get_associated_enclave_certificate_iam_roles(args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = ec2("GetAssociatedEnclaveCertificateIamRoles", args; aws_config=aws_config)
...
modify_address_attribute(AllocationId, args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = ec2("ModifyAddressAttribute", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AllocationId"=>AllocationId), args)); aws_config=aws_config)
...
modify_fleet(FleetId, args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = ec2("ModifyFleet", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("FleetId"=>FleetId), args)); aws_config=aws_config)
...
- `AddSubnetId`: (Interface and Gateway Load Balancer endpoints) One or more subnet IDs in which to serve the endpoint. For a Gateway Load Balancer endpoint, you can specify only one subnet.
- `DryRun`: Checks whether you have the required permissions for the action, without actually making the request, and provides an error response. If you have the required permissions, the error response is DryRunOperation. Otherwise, it is UnauthorizedOperation.
...
- `AddGatewayLoadBalancerArn`: The Amazon Resource Names (ARNs) of Gateway Load Balancers to add to your service configuration.
...
- `RemoveGatewayLoadBalancerArn`: The Amazon Resource Names (ARNs) of Gateway Load Balancers to remove from your service configuration.
...
reject_transit_gateway_multicast_domain_associations(args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = ec2("RejectTransitGatewayMulticastDomainAssociations", args; aws_config=aws_config)
...
reset_address_attribute(AllocationId, Attribute, args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = ec2("ResetAddressAttribute", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AllocationId"=>AllocationId, "Attribute"=>Attribute), args)); aws_config=aws_config)
...
- `CpuOptions`: The CPU options for the instance. For more information, see Optimizing CPU options in the Amazon EC2 User Guide.
...
- `ElasticGpuSpecification`: An elastic GPU to associate with the instance. An Elastic GPU is a GPU resource that you can attach to your Windows instance to accelerate the graphics performance of your applications. For more information, see Amazon EC2 Elastic GPUs in the Amazon EC2 User Guide.
...
- `EnclaveOptions`: Indicates whether the instance is enabled for AWS Nitro Enclaves. For more information, see  What is AWS Nitro Enclaves? in the AWS Nitro Enclaves User Guide. You can't enable AWS Nitro Enclaves and hibernation on the same instance.
- `HibernationOptions`: Indicates whether an instance is enabled for hibernation. For more information, see Hibernate your instance in the Amazon EC2 User Guide. You can't enable hibernation and AWS Nitro Enclaves on the same instance.
...
- `InstanceType`: The instance type. For more information, see Instance types in the Amazon EC2 User Guide. Default: m1.small 
...
- `RamdiskId`: The ID of the RAM disk to select. Some kernels require additional drivers at launch. Check the kernel requirements for information about whether you need to specify a RAM disk. To find kernel requirements, go to the AWS Resource Center and search for the kernel ID.  We recommend that you use PV-GRUB instead of kernels and RAM disks. For more information, see  PV-GRUB in the Amazon EC2 User Guide. 
