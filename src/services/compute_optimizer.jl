...
get_lambda_function_recommendations(args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = compute_optimizer("GetLambdaFunctionRecommendations", args; aws_config=aws_config)
